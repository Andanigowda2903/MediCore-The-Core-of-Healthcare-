...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
  ...
  <h4 style="margin-bottom: 0;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp CRYSTAL BAY HOSPITALS</h4>
  <p style="font-size: 12px; margin-top: 2px; text-align: center;"> Swasthyam Sarvartha Sādhanam</p>
</a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="assets/images/medical-team.png" alt=""/>
                        <h3>Welcome</h3>
